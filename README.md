...
<<<<<<< HEAD
新たに追加される2つのテーマの自動生成ダンジョンを攻略して沢山の魔法書や巻物、 そして固有レアアイテムを獲得したり、 それらのドロップを使ってあなた自身を強化したりできるようになるmodです。

新たに覚えることが可能な魔法の種類は　80　以上、 新たにダンジョンに登場するモンスターの種類は　120　以上存在し、各モンスターには固有のレアドロップが設定されています。
=======
新たに追加される2つのテーマの自動生成ダンジョンを攻略して沢山の魔法書や巻物、
そして固有レアアイテムを獲得したり、
それらのドロップを使ってあなた自身を強化したりできるようになるmodです。

新たに覚えることが可能な魔法の種類は　80　以上、 
新たにダンジョンに登場するモンスターの種類は　120　以上存在し、各モンスターには固有のレアドロップが設定されています。
>>>>>>> b5dd254c683a66a74989099f408125adc0cfde8c
